...
class NearbyHomeCard extends React.Component {
  ...
  handleHeartClick(id) {
    ...
    if (this.state.filled === 0) {
      axios.post(`/api/likes/1/${id}`)
        .then(() => {
          this.setState({
            filled: 1,
            heart: heartType1,
    ...
    } else if (this.state.filled === 1) {
      axios.delete(`/api/likes/1/${id}`)
      .then(() => {
        this.setState({
          filled: 0,
          heart: heartType0,
    ...
    return (
      <div className="houseCard">
        <div className="cardImageContainer">
          <img src={`https://sdcneighborhood.s3-us-west-1.amazonaws.com/${home.house_img}.jpg`} alt="home" className="cardImage" />
        </div>
        ...
        <div className="cardInfo">
          ...
          <div className="homeAddress smallText">{home.street_address}, San Francisco, CA</div>
          <div>
            ...
            <span className="bullet smallText"> • </span>
            <span className="smallText bold">{home.square_feet}</span>
